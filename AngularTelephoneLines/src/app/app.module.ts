...
@NgModule({
  declarations: [
    AppComponent, LoginComponent, AdminTemplateComponent, UserTemplateComponent, NotAuthorizedComponent,
    AccueilComponent, UtilisateursComponent, ProfileComponent, RapprochementComponent, AideComponent, UserAddEditComponent,
    HistoriquesComponent, CorbeilleComponent, TypeAttributComponent, GestionTypeComponent, GestionAttributComponent,
    LignesTelephoniqueComponent, LigneAddEditComponent, TypeLigneComponent, TypeLigneAddEditComponent, ParametreComponent,
  ],
    imports: [
        BrowserModule, AppRoutingModule, BrowserAnimationsModule, HttpClientModule, MatInputModule,
        MatCardModule, MatButtonModule, MatIconModule, MatDividerModule, MatTableModule, ReactiveFormsModule,
        MatSnackBarModule, MatAutocompleteModule, MatToolbarModule, MatMenuModule, NgOptimizedImage, MatSidenavModule,
        MatListModule, MatBadgeModule, MatPaginatorModule, MatSortModule, MatDialogModule, MatChipsModule, MatSelectModule,
        MatDatepickerModule, MatNativeDateModule, MatTooltipModule, MatTabsModule, MatSlideToggleModule, FormsModule,
